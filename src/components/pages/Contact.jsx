...
function Contact() {
  ...
  return (
    <main className="page-section" id="contact" style={{ paddingTop: "25px"}}>
        ...
        <div className="row gx-4 gx-lg-5 justify-content-center">
          <div className="col-lg-8 col-xl-6 text-center">
            ...
            <p className="text-muted mb-5">
              Contact us with this form to reach out about any questions or if you're interested in joining NHS!
            </p>
          </div>
        </div>
